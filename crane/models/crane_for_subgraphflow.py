...
class CraneForSubGraphFlow(nn.Module):
    def __init__(
            self,
        ...
        super(CraneForSubGraphFlow, self).__init__()
    ...
    def query_subgraph(self, subgraph_edges: torch.Tensor) -> torch.Tensor:
        return self.query(subgraph_edges).sum()
