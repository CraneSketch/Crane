...
def weight_scale_for(cfg: DictConfig, dataset_name: str) -> float:
    scales = OmegaConf.select(cfg, "data.weight_scale")
    return float(scales.get(dataset_name, 1.0)) if scales is not None else 1.0
